...
@section('container')
    ...
    @if ($presensitoday == null)
        <div class="wrapperbtn d-flex flex-column align-items-center py-3">
            ...
            <a href="#" id="izinBtn" class="btn btn-primary w-75 mb-2" data-url="{{ url('/dashboard/create?status=Izin') }}" data-status="Izin">Izin</a>
            <a href="{{ url('/dashboard/create?status=Sakit') }}" class="btn btn-primary w-75 mb-2"
                data-status="Sakit">Sakit</a>
            <a href="#" id="wfaBtn" class="btn btn-primary w-75 mb-2" data-url="{{ url('/dashboard/create?status=WFA') }}" data-status="WFA">WFA</a>
        </div>
    @else
        <div class="wrapper">
